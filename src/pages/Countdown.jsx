...
const Countdown = () => {
  ...
  return (
    <section className="py-12 md:py-16 bg-white text-[#043915] font-playfair">
      <div className="flex flex-col items-center justify-center gap-8 md:gap-12 px-6 md:px-16">
        
        {/* Animated Heading */}
        <motion.h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-center">
        ...
        {/* Countdown Numbers */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 md:gap-16 lg:gap-30 mt-8">
