      ...
      >
          ...
          {headingText.split("").map((char, index) => (
            <motion.span
              ...
              variants={{
                ...
                visible: { y: 0, opacity: 1, transition: { delay: 0.05 * index, duration: 0.5, ease: "easeOut" } },
              }}
          ...
          {countdownUnits.map((unit, i) => (
            <motion.div
              ...
              variants={{
                ...
                visible: { y: 0, opacity: 1, transition: { delay: 0.4 + i * 0.2, duration: 0.8, ease: "easeOut" } },
              }}
            >
        ...
        <motion.p
          ...
          variants={{
            ...
            visible: { opacity: 1, y: 0, transition: { delay: 1.2, duration: 0.8, ease: "easeOut" } },
          }}
        >
